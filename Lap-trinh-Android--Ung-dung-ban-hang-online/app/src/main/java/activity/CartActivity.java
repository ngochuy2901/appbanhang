            ...
            public void onClick(View v) {
                if (MainActivity.arrCart.size() > 0 ){
                    if(MainActivity.islogin) {
                        ...
                        CheckInternetConnection.ShowToast_Short(getApplicationContext(),"Đăng nhập để tiếp tục mua sắm");
                    }
                }else{
                    CheckInternetConnection.ShowToast_Short(getApplicationContext(),"Giỏ hàng trống!");
                }
            }
        });
    }
    ...
    private void CatchOnItemListView() {
        lvcart.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                builder.setMessage("Xac nhận xóa sản phẩm?");
